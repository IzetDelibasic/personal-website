export const projectsConstant = [
  ...
  },
  {
    ...
    description: "This is my first production project, where I worked for BlueDuck IT Services & Solutions company and built an app for Sumatherm Company using NextJS. I used TypeScript and Tailwind CSS. I learned to work with reusable components, constants, and other features for faster page speed.",
    imageSrc: "/images/sumathermImage.png",
    link: "https://sumatherm-project.vercel.app/",
