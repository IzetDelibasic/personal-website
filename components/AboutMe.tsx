    ...
    <div className='' id='aboutme'>
         <div className="space-y-12 mt-20 lg:mt-56">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 py-20">
                    <div className="col-span-1 text-3xl font-light leading-relaxed h-full items-center mt-24">
                        ...
                        <span className='font-bold'>Frontend development, coding and finding solutions for daily problems in real life using code. I also play handball.</span>
                    </div>
